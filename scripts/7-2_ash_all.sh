...
# UKB 
run_ash "${UKB_IN}/Neale.alzheimers.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.alzheimers.log"
run_ash "${UKB_IN}/Neale.asthma.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.asthma.log"
...
run_ash "${UKB_IN}/Neale.mean_corpuscular_hemoglobin.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.mean_corpuscular_hemoglobin.log"
...
run_ash "${UKB_IN}/Neale.red_blood_cell_count.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.red_blood_cell_count.log"
run_ash "${UKB_IN}/Neale.schizophrenia_ICD10.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.schizophrenia_ICD10.log"
run_ash "${UKB_IN}/Neale.height.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.height.log"
...
run_ash "${UKB_IN}/Neale.white_blood_cell_count.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.white_blood_cell_count.log"


run_ash "${UKB_IN}/Neale.basophil_percentage.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.basophil_percentage.irnt.log"
run_ash "${UKB_IN}/Neale.BMI.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.BMI.irnt.log"
run_ash "${UKB_IN}/Neale.mean_corpuscular_hemoglobin.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.mean_corpuscular_hemoglobin.irnt.log"
run_ash "${UKB_IN}/Neale.monocyte_percentage.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.monocyte_percentage.irnt.log"
run_ash "${UKB_IN}/Neale.neutrophill_percentage.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.neutrophill_percentage.irnt.log"
run_ash "${UKB_IN}/Neale.red_blood_cell_count.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.red_blood_cell_count.irnt.log"
run_ash "${UKB_IN}/Neale.height.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.height.irnt.log"
run_ash "${UKB_IN}/Neale.weight.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.weight.irnt.log"
run_ash "${UKB_IN}/Neale.white_blood_cell_count.irnt.cleaned.txt" "$UKB_OUT" "${UKB_OUT}/logs/Neale.white_blood_cell_count.irnt.log"

#AoU
run_ash "${AOU_IN}/Alzheimers_AoU.cleaned.txt" "$AOU_OUT" "${AOU_OUT}/logs/Alzheimers_AoU.log"
...
run_ash "${AOU_IN}/Mean_corpuscular_hemoglolbin_AoU.cleaned.txt" "$AOU_OUT" "${AOU_OUT}/logs/Mean_corpuscular_hemoglobin_AoU.log"
...
run_ash "${AOU_IN}/Red_blood_cell_count_AoU.cleaned.txt" "$AOU_OUT" "${AOU_OUT}/logs/Red_blood_cell_count_AoU.log"
...
run_ash "${AOU_IN}/White_blood_cell_count_AoU.cleaned.txt" "$AOU_OUT" "${AOU_OUT}/logs/White_blood_cell_count_AoU.log"
